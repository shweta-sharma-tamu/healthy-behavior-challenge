Feature: Updating Tasks
    ...
    Scenario: Unsuccessful todo list update
        ...
        Then I should see a flash notice with the message "Challenge has already ended. You cannot edit to do list."

    Scenario: Successful todo list update for future challenge
    ...
    Scenario: Successful todo list update for ongoing  challenge
