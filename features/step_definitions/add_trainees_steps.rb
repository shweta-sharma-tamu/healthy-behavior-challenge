Given("I am an instructor trying to add trainees to a challenge") do
    ...
    trainee_1 = Trainee.create(full_name:'Trainee1 Name', height:1, weight:1, user_id:user_2.id)
    trainee_2 = Trainee.create(full_name:'Trainee2 Name', height:2, weight:2, user_id:user_3.id)
    trainee_3 = Trainee.create(full_name:'Trainee3 Name', height:2, weight:2, user_id:user_4.id)
